...
(
    ...
    allow_concurrent        tinyint         not null        default 1                               comment '是否允许多节点并发执行，使用悲观锁实现，0：禁止，1：允许',
...
(
    ...
    allow_concurrent    tinyint         not null        default 0                               comment '是否允许多节点并行触发，使用悲观锁实现，0：禁止，1：允许',
    lock_version        bigint          not null        default 0                               comment '悲观锁',
